...
const RANDOM_ARTICLE_IMAGES = [
  ...
  'https://images.unsplash.com/photo-1617897903246-719242758050?w=600&h=400&fit=crop&q=80',
  'https://images.unsplash.com/photo-1551076805-e1869033e561?w=600&h=400&fit=crop&q=80',
  'https://images.unsplash.com/photo-1505909182942-e2f09aee3e89?w=600&h=400&fit=crop&q=80',
  'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=600&h=400&fit=crop&q=80',
  'https://images.unsplash.com/photo-1584036561566-baf8f5f1b144?w=600&h=400&fit=crop&q=80'
];

const getRandomImage = () => RANDOM_ARTICLE_IMAGES[Math.floor(Math.random() * RANDOM_ARTICLE_IMAGES.length)];
...
export const DISEASE_RESOURCES: Record<string, DiseaseResources> = {
  ...
  'Basal Cell Carcinoma': {
    ...
    articles: [
      { id: 'bcc-a1', title: 'Basal Cell Carcinoma -- What It Is and How It Is Treated', description: 'Everything you need to know about the most common form of skin cancer, from early signs to cure rates.', source: 'Mayo Clinic', url: 'https://www.mayoclinic.org/diseases-conditions/basal-cell-carcinoma/symptoms-causes/syc-20354187', image: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&h=250&fit=crop&q=80', publishedDate: '2024-01-20', category: 'skin cancer' },
...
export const fetchSkinArticles = async (disease?: string): Promise<Article[]> => {
  ...
  if (disease) {
    ...
    if (resources?.articles.length) {
      result = resources.articles;
    }
  }
  
  if (result.length === 0) {
    // Return a mix from all diseases as generic content
    result = Object.values(DISEASE_RESOURCES)
      .flatMap(r => r.articles)
      .slice(0, 6);
  }

  // Randomize the images on fetch to prevent repetition
